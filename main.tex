...
\subsubsection{\underline{Lineare Funktionen:}} 
\begin{itemize}
...
\end{itemize}
\subsubsection{\underline{Quadratische Funktionen:}}
\begin{itemize}
...
\lim\limits_{x \to \pm\infty} f(x) = -\infty$
\end{itemize}
\subsubsection{\underline{Polynome:}}
\begin{itemize}
...
\end{itemize}
\subsubsection{\underline{Gebrochen-rationale Funktionen}}
\begin{itemize}
...
\end{enumerate}\\
 ...
 \end{itemize}
 \subsubsection{\underline{$e-$Funktion:}}
 \begin{itemize}
 \item $f(x) = e^x$
...
\item Bei der Kurvendiskussion wird die $e-$Funktion meistens als Produkt mit einer anderen Funktion betrachtet.\footnote{$f(x) = g(x)\cdot e^{h(x)}  \longrightarrow f'(x) =g'(x)\cdot e^{h(x)} + g(x) \cdot h'(x) \cdot e^{h(x)} $}
 \end{itemize}
 \subsubsection{\underline{$ln-$Funktion:}}
 \begin{itemize}
...
\item Bei der Kurvendiskussion wird die $ln-$Funktion meistens in Kombination mit einer anderen Funktion betrachtet.\footnote{$f(x) = \ln{(g(x))}  \longrightarrow f'(x) = \dfrac{1}{ g(x)} \cdot g'(x) = \dfrac{g'(x)}{g(x)} $}
 \end{itemize}
 \subsubsection{\underline{Wurzelfunktion:}}
 \begin{itemize}
...
\item Ableitung $f(x)= \sqrt{g(x)} \longrightarrow f'(x) = \frac{g'(x)}{2\cdot \sqrt{g(x)}}$
 \end{itemize}
 \subsubsection{\underline{allgemeine Sinusfunktion:}} 
 \begin{itemize}
...
\item Der Parameter b streckt bzw. staucht die Kurve in Richtung der x-Achse. Durch den Faktor b wird damit die Periode $p$ verändert $p = \frac{2\cdot \pi}{b}$.\\
 ...
 \end{itemize}
 \subsubsection{\underline{Betragsfunktionen:}}
 \begin{itemize}
...
Bei der Kurvendiskussion werden Eigenschaften des Graphen $G_f$ einer Funktion $f$ analytisch untersucht
 \subsubsection{\underline{Untersuchung der Ausgangsfunktion:}}
 \begin{itemize}
 ...
 \end{itemize}
 \subsubsection{\underline{Monotonie:}}
 \begin{itemize}
...
\end{tabular}}
 \end{itemize}
 \subsubsection{\underline{Krümmungsverhalten:}}
 \begin{itemize}
