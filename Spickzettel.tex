...
\begin{enumerate}
    \item Volumen eines Spates $\longrightarrow V_{\text{Spat}} = |\left(\vv{AB} \times \vv{AC} \right)\circ\vv{AD}|$\\
    \item Volumen einer dreiseitigen Pyramide\\ $ \longrightarrow V_{\text{Pyramide}}= |\frac{1}{6}\cdot \left(\vv{AB} \times \vv{AC} \right)\circ\vv{AD}| $
\end{enumerate}
\end{itemize}
